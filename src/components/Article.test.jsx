...
describe('Article', () => {
    ...
    const testArticle = {
            ...
            "accessionYear": "2008",
            "isPublicDomain": true,
            "primaryImage": "https://images.metmuseum.org/CRDImages/ad/original/DP364292.jpg",
            "primaryImageSmall": "https://images.metmuseum.org/CRDImages/ad/web-large/DP364292.jpg",
            "additionalImages": [
    ...
    it('Should render Article component correctly', () => {
        ...
        ).toHaveAttribute('src', testArticle?.primaryImage)

        expect(screen.getByRole('heading', { level: 4 })).toHaveTextContent(testArticle?.title)
        expect(screen.getByRole('contentinfo')).toHaveTextContent(`${testArticle.country} ${testArticle.city}`)
    })
})